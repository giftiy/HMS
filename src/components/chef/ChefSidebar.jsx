// src/components/chef/ChefSidebar.jsx
...
export default function ChefSidebar() {
  ...
  const menuItems = [
    { name: "Dashboard", icon: <FaTachometerAlt />, path: "/chef/dashboard" },
    { name: "Drinks", icon: <FaCoffee />, path: "/chef/drink" },
    { name: "Food", icon: <FaUtensils />, path: "/chef/food" },
    { name: "Snacks", icon: <FaHamburger />, path: "/chef/snack" },
  ];
    ...
    >
      ...
      <div>
        ...
        >
          ...
          />
          {!collapsed && <span>Chef Panel</span>}
        </div>
